...
import { getArticleByIdA } from '../api/articleapi';
...
<template>
    <div class="news-body">
        <div class="header">
            <a>{{ article.firstCategory === null ? '其他' : article.firstCategory.name }}</a>
            ...
            <div class="content-body">
                ...
                <div class="author">
                    <div class="left">
                        <div class="img-div">
                            <a>
                                <img :src="article.user.avatar === null ? '/defaultavatar.jpg' : article.user.avatar" />
                            </a>
                        </div>
                        <div class="author-info">
                            <div class="name"><a href="">{{ article.user.name }}</a></div>
